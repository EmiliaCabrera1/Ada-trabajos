...
let sonMayoresQueDiez = primerNumero > 10 && segundoNumero > 10;

if (sonMayoresQueDiez) {
  console.log(
    `Ambos números (${primerNumero} y ${segundoNumero}) son mayores que 10.`
  );
} else {
  console.log(`Uno o ambos numeros es menor a 10.`);
}
