...
suma, resta, multiplicación o división. Según la operación ingresada, el programa deberá 
calcular y mostrar el resultado. Si el usuario ingresa una operación inválida, el programa 
...
let operacion = prompt(
  "Introduce la operación a realizar (suma, resta, multiplicación, división): "
)
  .toLowerCase()
  .replace("ó", "o");
...
switch (operacion) {
  ...
  default:
    console.log(
      "Operación no reconocida, por favor ingresa suma, resta, multiplicación o división."
    );
}
